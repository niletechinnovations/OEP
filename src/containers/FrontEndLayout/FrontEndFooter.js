          ...
          <MDBContainer className="foot-padding text-center text-md-left">
            <MDBRow>
              ...
              <MDBCol md="4">
                  ...
                  <div className="branding-logo-footer"><p><strong>Powered By:</strong></p><img src = "https://retailoep.com/images/OEP_Retail_Tech.jpg" alt="OEP Retail Tech" width ="170" /></div>
              </MDBCol>
