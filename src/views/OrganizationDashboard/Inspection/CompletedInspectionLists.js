...
class CompletedInspectionLists extends Component {
  constructor(props){
    super(props);
    this.state = {
      modal: false,      
  ...
  render() {
    ...
    const { inspectionList, loading, categoryList, subCategoryList, templateList, employeeList} = this.state;     
    let loaderElement = '';
    if(loading)        
...
export default CompletedInspectionLists;
