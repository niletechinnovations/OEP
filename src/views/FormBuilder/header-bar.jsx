    ...
    return (
      <div className="toolbar-header">
        ...
        <div className="toolbar-header-buttons">
          ...
          <div className="btn is-isolated btn-school" onClick={this.props.copyModeOn.bind(this.props.parent, this.props.data)}><i className="is-isolated fa fa-copy"></i></div>
