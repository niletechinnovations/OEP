  ...
  render() {
    ...
    return (
      <div className={baseClasses}>
        <ComponentHeader {...this.props} />
        <div className="form-group">
          <a target="_blank" href={this.props.data.href} rel='noreferrer noopener'>{this.props.data.content}</a>
        </div>
      </div>
    );
  }
      ...
      <div className={baseClasses}>
        ...
        <div className="form-group">
          ...
          {this.props.read_only === true && this.props.defaultValue && this.props.defaultValue.length > 0
            ? (<div><img src={sourceDataURL} alt="" /></div>)
            ...
            { this.state.img &&
              <div>
                <img src={ this.state.img } height="100" className="image-upload-preview" alt="" /><br />
